...
class BaseTrainer:
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    save_every_epoch = getattr(self.settings, "save_every_epoch", True) # Save every epoch
    ...
    def save_checkpoint(self):
        ...
        api.upload_folder(
            ...
            repo_id="azeem23/seqtrack",
            repo_type="model",  # or "model", "space"
            commit_message=f"Uploaded checkpoint {self.epoch}"
        )
